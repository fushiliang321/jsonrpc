...
func main() {
	...
	err1 := c.Call("IntRpc/Add", Params{1, 6}, result1, false, nil) // or "int_rpc/Add", "int_rpc.Add", "IntRpc.Add"
	...
	// notify
	result2 := new(Result2)
	err2 := c.Call("int_rpc/Add2", Params{1, 6}, result2, true, nil) // or "IntRpc/Add2", "int_rpc.Add2", "IntRpc.Add2"
	...
	// batch call
	result3 := new(Result)
	err3 := c.BatchAppend("IntRpc/Add1", Params{1, 6}, result3, false, nil)
	result4 := new(Result)
	err4 := c.BatchAppend("IntRpc/Add", Params{2, 3}, result4, false, nil)
	c.BatchCall()
